...
# Implementation
# - implementation 2 for the J1-J2 model
# - labels <: Any
function getUnitcellSquare(
            unitcell_type  :: Type{U},
    ...
    return newUnitcell(
        ...
        # bonds
        B[
            newBond(B, 1,1, getDefaultLabelX(LB), (+1,0)),
            newBond(B, 1,1, getDefaultLabelX(LB), (-1,0)),
            newBond(B, 1,1, getDefaultLabelX(LB), (0,+1)),
            newBond(B, 1,1, getDefaultLabelX(LB), (0,-1)),

            newBond(B, 1,1, getDefaultLabelY(LB), (+1,+1)),
            newBond(B, 1,1, getDefaultLabelY(LB), (+1,-1)),
            newBond(B, 1,1, getDefaultLabelY(LB), (-1,+1)),
            newBond(B, 1,1, getDefaultLabelY(LB), (-1,-1))
        ]
...
# Implementation
# - implementation -3 (same as 3 but with pi flux)
# - labels <: Any
function getUnitcellSquare(
            unitcell_type  :: Type{U},
            implementation :: Val{-3}
    ...
    return newUnitcell(
        ...
        B[
            ...
            newBond(B, 3,4, getDefaultLabelX(LB), (0,0)),
            newBond(B, 3,2, flipLabel(getDefaultLabelX(LB)), (0,0)),
            newBond(B, 3,4, getDefaultLabelY(LB), (1,0)),
            newBond(B, 3,2, flipLabel(getDefaultLabelY(LB)), (0,1)),
